...
<div  class="container">
  ...
  <h1 class="mb-3 text-center ">{{pageTitle}}</h1>
    <div class=" row">    
      ...
      <div class="modal fade show" v-bind:id="'exampleModal'+movie.id" tabindex="-1" role="dialog" aria-labelledby="exampleModalLongTitle" aria-hidden="true">
        <div class="modal-dialog" role="document">
          ...
          <span aria-hidden="true">&times;</span>
            ...
            <div class="ml-2 mr-2 progress">
            <div class=" progress-bar bg-success" role="progressbar" v-bind:style="'width:' + movie.vote_average * 10 + '%' " aria-valuenow="75" aria-valuemin="0" aria-valuemax="100">Rating : {{movie.vote_average * 10}} /100</div>
            </div>
